var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		// 获取特定div作为背景
		// canvas-particle是你想要将其作为背景的div的ID
		var body = document.getElementById("canvas-particle");
	...
	function canvasSize(canvas){
		...
		// 获取特定div的宽高
		var width = document.getElementById("canvas-particle").style.width;
		var height = document.getElementById("canvas-particle").style.height;
