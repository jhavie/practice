  ...
  <div
    ...
    <div
      ...
      <div
        ...
        <i class="ep-step__line-inner" :style="lineStyle"></i>
      </div>

      <span class="ep-step__icon">
        <slot
        ...
        <i
          v-else
          :class="[(currentStatus === 'success' ? 'ion-checkmark-round' : 'ion-close-round')]">
        </i>
      </span>
    </div>
    <div
      ...
      <div
        class="ep-step__title"
        ref="title"
        :class="['is-' + currentStatus]">
        <slot name="title">{{ title }}</slot>
      </div>
      <div
        class="ep-step__description"
        :class="['is-' + currentStatus]">
